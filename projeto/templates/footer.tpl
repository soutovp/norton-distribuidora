    ...
    <section class="section-sobre">
      ...
      <div class="norton-footer-redes">
        ...
        <div>
          ...
          <a href="https://www.tiktok.com/@nortondistribuido" class="norton-redes" target="_blank">
            <img src="{{ variables.icones_loja.tiktok }}" alt="Tiktok">
          </a>
          <a href="https://www.youtube.com/@nortononline" class="norton-redes" target="_blank">
            <img src="{{ variables.icones_loja.youtube }}" alt="Youtube">
          </a>
        </div>
      </div>
    </section>
