...
<div class="collection-grid mode-{{ paginate.type?:"grid" }} flex" direction="row" wrap="true" columns="{{paginate.columns}}" gap="10" colums-list="{{ variables.cms_grade_produtos.cms_mobile_dual_col ? 1 : 1 }}">
